...
import { orgAdminGroupedItems } from "@/apps/supplymantix/components/Layout/organizationAdminSidebarMenuItems";
                  ...
                  <SidebarMenuItem key={item.title}>
                    ...
                    >
                      <Link to={item.url} className="flex items-center space-x-3 w-full">
                        ...
                        {isActive && (
                          <div className="absolute right-3 w-1.5 h-1.5 rounded-full bg-gradient-to-r from-blue-400 to-indigo-400 shadow-sm shadow-blue-400/50"></div>
                        )}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
