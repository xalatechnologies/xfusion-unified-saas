...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-[var(--color-muted)] [&:has([role=checkbox])]:pr-0 font-family-[var(--font-family)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0 font-family-[var(--font-family)]", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-sm text-[var(--color-muted)] font-family-[var(--font-family)]", className)}
    {...props}
  />
))
